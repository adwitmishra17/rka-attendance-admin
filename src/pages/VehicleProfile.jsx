...
// VEHICLE PROFILE
//
// Per-vehicle detail page (route /vehicles/:id).
//   - Header: photo thumbnail + RC + type/status badges + meta
//   - Vehicle details card
//   - Documents (RC, Insurance, PUC, Permit, Fitness)
//   - Driver & conductor assignments
// ============================================================================
...
export default function VehicleProfile() {
  ...
  return (
    <div style={{ padding: '32px 36px', maxWidth: 1100 }}>
      ...
      {/* Header — photo thumbnail beside the RC + meta */}
      ...
      >
        <VehicleAssignmentsSection vehicle={v} />
      </Section>
    </div>
  )
}
